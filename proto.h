...
void	cpy7bit _((char* d, char* s, I32 l));
...
void	cryptfilter _((FILE* fil));
void	cryptswitch _((void));
void	cv_undef _((CV* cv));
#ifdef DEBUGGING
void	cx_dump _((CONTEXT* cs));
#endif
I32	cxinc _((void));
void	deb _((char* pat,...)) __attribute__((format(printf,1,2),noreturn));
...
char*	nsavestr _((char* sv, I32 len));
OP *	oopsCV _((OP* o));
...
void	perl_init_ext _((void));
int	perl_parse _((PerlInterpreter* sv_interp, int argc, char** argv, char** env));
...
regexp*	regcomp _((char* exp, char* xend, I32 fold));
